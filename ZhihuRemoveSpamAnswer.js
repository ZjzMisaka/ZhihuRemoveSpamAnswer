...
(function() {
    ...
    function Ana(){
        ...
        for (var k = 0; k < richContentList.length; ++k) {
            ...
            if(contentText.parentElement.classList.contains('is-collapsed') || contentText.parentElement.parentElement.classList.contains('is-collapsed')) {
    ...
    function Res2(contentInnerText) {
        if(contentInnerText.startsWith("世界卫生组织（WHO）根据智商将精神发育迟滞分为以下四个等级")
          || contentInnerText.startsWith("世界卫生组织（ WHO ）根据智商将精神发育迟滞分为以下四个等级")
          ...
          || contentInnerText.startsWith("根据智商值的大小划分智残等级，有轻度、中度、重度、极重度四个等级。")
          || contentInnerText.startsWith("世界卫生组织(WHO)将精神发育迟滞分为4个等级")
